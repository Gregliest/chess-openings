...
function ccall(e, r, t, n, o) {
	...
	return (
		(d = f),
		(f = 'string' === r ? UTF8ToString(d) : 'boolean' === r ? Boolean(d) : d),
		0 !== u && stackRestore(u),
		f
	);
}
...
function ___setErrNo(e) {
	return (
		Module.___errno_location && (HEAP32[Module.___errno_location() >> 2] = e), e
	);
}
...
var PATH = {
	...
	NODEFS = {
		...
		getMode: function (e) {
			...
			try {
				(r = fs.lstatSync(e)),
					NODEFS.isWindows && (r.mode = r.mode | ((292 & r.mode) >> 2));
			} catch (e) {
				if (!e.code) throw e;
		...
		open: function (r, e, t, n, o) {
			...
			u.stream_ops.open && u.stream_ops.open(u),
				!Module.logReadFiles ||
					...
					r in FS.readFiles ||
						((FS.readFiles[r] = 1),
						console.log('FS.trackingDelegate error on read file: ' + r)));
			try {
							...
							void 0 === a.chunks[e] &&
								(a.chunks[e] = (function (e, r) {
									...
									if (
										...
										throw new Error(
											"Couldn't load " + s + '. Status: ' + t.status,
										);
...
function _emscripten_set_main_loop_timing(e, r) {
	...
	if (0 == e)
		(Browser.mainLoop.scheduler = function () {
			var e =
				0 |
				Math.max(0, Browser.mainLoop.tickStartTime + r - _emscripten_get_now());
